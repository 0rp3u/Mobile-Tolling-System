...
class ServerApplication{
    ...
    fun initialize(): CommandLineRunner = CommandLineRunner {
        ...
        poly.srid = 4326
        val toll = Toll.create(1,"road below", true, "Brisa",geometryFactory.createPoint(Coordinate(-9.1129222, 38.7555662)), poly)
        val toll2 = Toll.create(2,"isel parking lot", true, "Brisa",geometryFactory.createPoint(Coordinate(-9.1143576, 38.755951)), poly)
