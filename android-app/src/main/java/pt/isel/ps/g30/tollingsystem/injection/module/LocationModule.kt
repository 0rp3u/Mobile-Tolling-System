...
import pt.isel.ps.g30.tollingsystem.geofencing.GeofenceBroadcastReceiver
...
class LocationModule {
    ...
    fun provideGeofenceBroadcastPendingIntent(app: TollingSystemApp): PendingIntent{
        return PendingIntent.getBroadcast(app, 0, Intent(app, GeofenceBroadcastReceiver::class.java), PendingIntent.FLAG_UPDATE_CURRENT)
    }
