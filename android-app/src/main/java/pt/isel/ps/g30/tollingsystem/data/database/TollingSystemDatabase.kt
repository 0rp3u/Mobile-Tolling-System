...
@Database(entities = [User::class, TollingPlaza::class, Vehicle::class, TollingTransaction::class, TemporaryTransaction::class, Notification::class, TollingPassage::class, Point::class], version = 1)
